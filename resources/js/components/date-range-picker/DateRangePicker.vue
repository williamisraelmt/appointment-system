  ...
  <div class="d-flex daterangepicker-row">
    ...
    <div class="daterangepicker-col">
      ...
      <div class="form-group form-inline flex-nowrap">
        <input type="text" class="form-control form-control-sm w-100 daterangepicker-date-input"
          ref="startDate"
      ...
      <div v-if="compare">
        ...
        <div class="form-group form-inline flex-nowrap">
          <input type="text" class="form-control form-control-sm w-100 daterangepicker-date-input compare"
      ...
      <div class="form-group form-inline justify-content-end mb-0">
        ...
        <button type="button" class="btn btn-primary ml-2" :disabled="step != null" @click="submit">Aceptar</button>
      </div>
    </div>
  </div>
</template>
      ...
      default: function() {
        return {
          nextWeek: {
              ...
              startDate: moment.utc().add(1, 'week').startOf('week'),
              endDate: moment.utc().add(1, 'week').endOf('week').startOf('day')
            },
          currentMonth: {
            label: 'Este mes',
          ...
          nextMonth: {
              label: 'El mes que viene',
              startDate: moment.utc().add(1, 'month').startOf('month'),
              endDate: moment.utc().add(1, 'month').endOf('month').startOf('day')
          },
          twoMonths: {
              label: 'En dos meses',
              startDate: moment.utc().add(2, 'month').startOf('month'),
              endDate: moment.utc().add(2, 'month').endOf('month').startOf('day')
          },
        }
      }
    },
